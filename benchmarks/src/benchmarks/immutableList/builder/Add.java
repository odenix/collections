...
public class Add {
  ...
  @Benchmark
  public PersistentList.Builder<String> addLast() {
    return Utils.persistentListBuilderAdd(size, immutablePercentage);
  }
  ...
  @Benchmark
  public PersistentList.Builder<String> addFirst() {
    var builder = Utils.persistentListBuilderAdd(size - 1, immutablePercentage);
    builder.add(0, "another element");
    return builder;
  }

  @Benchmark
  public PersistentList.Builder<String> addMiddle() {
    var builder = Utils.persistentListBuilderAdd(size - 1, immutablePercentage);
