...
public class Put {
  ...
  @Benchmark
  public PersistentMap.Builder<ObjectWrapper<Integer>, String> put() {
    return Utils.persistentMapBuilderPut(implementation, keys, immutablePercentage);
  }
