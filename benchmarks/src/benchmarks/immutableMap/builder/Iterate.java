...
public class Iterate {
  ...
  private PersistentMap.Builder<ObjectWrapper<Integer>, String> builder = PersistentMap.<ObjectWrapper<Integer>, String>of().builder();

  @Setup
  public void prepare() {
    var keys = HashCodeTypes.generateKeys(hashCodeType, size);
    builder = Utils.persistentMapBuilderPut(implementation, keys, immutablePercentage);
  }

  @Benchmark
  public void iterateKeys(Blackhole bh) {
    for (var k : builder.keySet()) {
      bh.consume(k);
    }
  }
