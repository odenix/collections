...
public class Add {
  ...
  @Benchmark
  public ImmutableSet<ObjectWrapper<Integer>> add() {
    return Utils.persistentSetAdd(implementation, elements);
  }

  @Benchmark
  public void addAndContains(Blackhole bh) {
    var set = Utils.persistentSetAdd(implementation, elements);
    for (var index = 0; index < size; index++) {
      bh.consume(set.contains(elements.get(index)));
    }
  }
